        ...
        categoryItems.forEach(item => {
            item.addEventListener('click', function (e) {
                ...
                categoryItems.forEach(i => {
                    ...
                    i.querySelector('.category-text').style.fontWeight = 'normal';
                });

                this.classList.add('active');
                this.querySelector('.category-text').style.fontWeight = 'bold';
  ...
  "school.html"
    ...
    async function performSearch(query) {
        ...
        for (const page of pages) {
            try {
                ...
                let category = '', author = '', date = '', videoUrl = '', contentText = '';
    ...
    function showResults(results) {
        ...
        results.forEach(result => {
            ...
            const videoBadge = result.videoUrl ? '<i class="fas fa-video video-badge"></i>' : '';
